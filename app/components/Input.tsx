...
/**
 * Reusable outer container for any Input/Textarea in the app.
 * Use this around <NativeInput /> to get the refined Apple-style field:
 *   - 12px squircle radius
 *   - soft layered shadow on focus
...
export const InputContainer = styled.div<{
  ...
  ${(props) =>
    ...
    box-shadow: 0 0 0 3px ${transparentize(0.84, props.theme.accent)},
  ...
  ${(props) =>
    ...
    box-shadow: 0 0 0 3px ${transparentize(0.88, props.theme.danger)};
  `}
`;
